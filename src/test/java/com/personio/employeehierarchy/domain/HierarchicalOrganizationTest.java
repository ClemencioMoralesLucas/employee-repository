...
class HierarchicalOrganizationTest {
    ...
    @BeforeEach
    public void setUp() {
        this.bigBoss = new Employee(BIG_BOSS_NAME);//jane
        this.liquidSnake = new Employee(LIQUID_SNAKE_NAME);//olga
        this.solidSnake = new Employee(SOLID_SNAKE_NAME);//amanda
        this.revolverOcelot = new Employee(REVOLVER_OCELOT_NAME);//carl
        this.sniperWolf = new Employee(SNIPER_WOLF_NAME);//samuel
